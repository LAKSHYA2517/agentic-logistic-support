...
class ProcessingResult(BaseModel):
    ...
    This is the entire Phase 2 -> Phase 1 integration contract. Phase 1
    decides what to do with it (e.g. only persist the extraction and
    move the shipment to ``IN_TRANSIT`` when ``status == ACCEPTED``);
    Phase 2 never touches Shipment or SQLite itself.
